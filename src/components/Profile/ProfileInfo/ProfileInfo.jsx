  ...
  return (
    <div className={clas.content}>
      <div className={clas.profileTips}>
        <img className={clas.cont} src='https://png.pngtree.com/thumb_back/fh260/background/20200801/pngtree-wide-view-of-sunset-background-with-a-boat-image_375681.jpg'></img>
      </div>
      <div>
        <img src={props.profile.photos.large || logo} className={clas.mainPhoto}></img>
        <div>
    ...
    <div>
      ...
      <div className={clas.contact}>
        <b>Contacts:</b> {Object.keys(props.profile.contacts).map(key => {
          return <Contact ContactKey={key} ContactValue={props.profile.contacts[key]} />
        })}
      </div>
    </div>
  )
