...
export const setUserAuthData = (id: number, login: string, email: string, isAuth: boolean):setUserAuthDataActionType => ({ type: USER_AUTH_DATA, payload: { id, login, email, isAuth } });
